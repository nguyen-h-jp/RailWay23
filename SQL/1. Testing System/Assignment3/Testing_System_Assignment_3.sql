-- 1. thêm ít nhất 10 record vào mỗi bảng
...
SELECT *
FROM answer;
SELECT question_id, COUNT(question_id) AS 'số lượng câu trả lời', answer_id
FROM answer
...
SELECT *
FROM `account`;
SELECT COUNT(department_id) AS 'số nhân viên thuộc department_id = 2'
FROM `account`
WHERE department_id = 2;
-- 11. lấy ra số nhân viên có tên bắt đầu bằng chữ "D" và kết thúc bằng chữ "o"
SELECT *
FROM `account`
WHERE full_name LIKE 'N%b';
